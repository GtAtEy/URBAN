...
public class OwnerInfo extends User {
	...
	public OwnerInfo(Long id, String uuid, String userName, String password, String salutation, String name,
					 ...
					 String institutionId, Status status, List<Document> documents, Relationship relationship, String alternatemobilenumber, String title, String samagraId) {
		super(id, uuid, userName, password, salutation, name, gender, mobileNumber, emailId, altContactNumber, pan,
				...
				createdDate, lastModifiedBy, lastModifiedDate, tenantId,alternatemobilenumber,title,samagraId);
	...
	public OwnerInfo(OwnerInfo ownerInfo) {
		...
		super(ownerInfo.getId(), ownerInfo.getUuid(), ownerInfo.getUserName(), ownerInfo.getPassword(), ownerInfo.getSalutation(),
				...
				ownerInfo.getLastModifiedBy(), ownerInfo.getLastModifiedDate(), ownerInfo.getTenantId(),ownerInfo.getAlternatemobilenumber(),ownerInfo.getTitle(),ownerInfo.getSamagraId());
